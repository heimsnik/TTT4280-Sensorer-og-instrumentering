...
/* RPi PIN ASSIGNMENTS */
#define MISO1 11    // ADC 1 MISO (BCM 4 aka GPIO 4).
#define MISO2 12    //     2
#define MISO3 16    //     3
#define MISO4 18    //     4
#define MISO5 22    //     5

#define MOSI 13     // GPIO for SPI MOSI (BCM 10 aka GPIO 10 aka SPI_MOSI). MOSI not in use here due to single ch. ADCs, but must be defined anyway.
